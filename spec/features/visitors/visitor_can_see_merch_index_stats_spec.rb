...
describe 'As a Visitor' do
  before(:each) do
    ...
    @user_10 = create(:user, city: "timmy", state: "D.C.")
  ...
  it 'shows top three largest orders by quantity' do
    within ".top-three-largest-orders" do
      ...
      expect(page).to_not have_content(@order_item_3.quantity)
    end
  end
end
