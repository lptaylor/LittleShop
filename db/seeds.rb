...
user_5 = User.create!(name: Faker::Name.unique.name, address: Faker::Address.unique.street_address , city: Faker::Address.unique.city, state: Faker::Address.state, zipcode: Faker::Address.unique.zip, email: "merch@aol.com", password: "1234", role: 1)
